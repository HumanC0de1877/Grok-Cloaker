        ...
        <div className="flex h-full flex-col border-r">
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center gap-3">
              <div className="flex aspect-square size-10 items-center justify-center rounded-none bg-gradient-to-br from-purple-600 to-blue-600 text-white">
          ...
          <div className="px-3 py-2">
            <div className="relative">
              ...
              <Input type="search" placeholder="Search..." className="w-full rounded-none bg-muted pl-9 pr-4 py-2" />
            </div>
          </div>
            ...
            <div className="space-y-1">
              {sidebarItems.map((item) => (
                <div key={item.title} className="mb-1">
                  <button
                    className={cn(
                      "flex w-full items-center justify-between rounded-none px-3 py-2 text-sm font-medium",
                  ...
                  >
                    ...
                    {item.badge && (
                      <Badge variant="outline" className="ml-auto rounded-sm px-2 py-0.5 text-xs">
                        {item.badge}
                      </Badge>
                    )}
                    {item.items && (
                    ...
                    <div className="mt-1 ml-6 space-y-1 border-l pl-3">
                      {item.items.map((subItem) => (
                        <a
                          key={subItem.title}
                          href={subItem.url}
                          className="flex items-center justify-between rounded-none px-3 py-2 text-sm hover:bg-muted"
                        >
                          {subItem.title}
                          {subItem.badge && (
                            <Badge variant="outline" className="ml-auto rounded-sm px-2 py-0.5 text-xs">
          ...
          <div className="border-t p-3">
            <div className="space-y-1">
              <button className="flex w-full items-center gap-3 rounded-none px-3 py-2 text-sm font-medium hover:bg-muted">
                <Settings className="h-5 w-5" />
                <span>Settings</span>
              </button>
              <button className="flex w-full items-center justify-between rounded-none px-3 py-2 text-sm font-medium hover:bg-muted">
                <div className="flex items-center gap-3">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button variant="ghost" size="icon" className="rounded-none relative">
                      ...
                      {notifications > 0 && (
                        <span className="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center rounded-sm bg-red-500 text-xs text-white">
                          {notifications}
                        </span>
                      )}
                    </Button>
        ...
        <main className="flex-1 p-4 md:p-6">
          <Tabs defaultValue="home" value={activeTab} onValueChange={setActiveTab} className="w-full">
            <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <TabsList className="grid w-full max-w-[600px] grid-cols-5 rounded-none p-1">
                      ...
                      <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                        <div className="space-y-4">
                          ...
                          <div className="flex flex-wrap gap-3">
                            <Button className="rounded-none bg-white text-indigo-700 hover:bg-white/90">
                              Explore Plans
                            </Button>
                            <Button
                              variant="outline"
                              className="rounded-none bg-transparent border-white text-white hover:bg-white/10"
                            >
                              Take a Tour
                            </Button>
                          </div>
                        ...
                        <div className="hidden lg:block">
                          ...
                          >
                            <div className="absolute inset-0 rounded-sm bg-white/10 backdrop-blur-md" />
                            <div className="absolute inset-4 rounded-sm bg-white/20" />
                            <div className="absolute inset-8 rounded-sm bg-white/30" />
                            <div className="absolute inset-12 rounded-sm bg-white/40" />
                            <div className="absolute inset-16 rounded-sm bg-white/50" />
                          </motion.div>
                        </div>
                      </div>
                    </motion.div>
                  ...
                  <section>
                    ...
                    >
                      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                        ...
                        <Button className="w-fit rounded-none bg-white text-red-700 hover:bg-white/90">
                          <Download className="mr-2 h-4 w-4" />
                          Install Desktop App
                        </Button>
                      </div>
                  ...
                  <div className="flex flex-wrap gap-3 mb-6">
                    ...
                    <div className="relative w-full md:w-auto mt-3 md:mt-0">
                      ...
                      <Input
                        ...
                        className="w-full rounded-none pl-9 md:w-[200px]"
                      />
                    </div>
                  </div>
                  ...
                  <section>
                    ...
                    >
                      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                        ...
                        <div className="flex flex-wrap gap-3">
                          <Button className="rounded-none bg-white/20 backdrop-blur-md hover:bg-white/30">
                            <Cloud className="mr-2 h-4 w-4" />
                            Cloud Storage
                          </Button>
                          <Button className="rounded-none bg-white text-blue-700 hover:bg-white/90">
                            <Plus className="mr-2 h-4 w-4" />
                            Upload Files
                          </Button>
                        </div>
                  ...
                  <section>
                    ...
                    >
                      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                        ...
                        <Button className="w-fit rounded-none bg-white text-indigo-700 hover:bg-white/90">
                          <Plus className="mr-2 h-4 w-4" />
                          New Project
                        </Button>
                      </div>
                    ...
                    <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
                      ...
                      <motion.div whileHover={{ scale: 1.02, y: -5 }} whileTap={{ scale: 0.98 }}>
                        <Card className="flex h-full flex-col items-center justify-center rounded-3xl border border-dashed p-8 hover:border-primary/50 transition-all duration-300">
                          ...
                          <Button className="rounded-none">New Project</Button>
                        </Card>
                      </motion.div>
                    </div>
                  </section>
                  ...
                  <section>
                    ...
                    >
                      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                        ...
                        <Button className="w-fit rounded-none bg-white text-emerald-700 hover:bg-white/90">
                          ...
                          <Card className="overflow-hidden rounded-3xl">
                            <div className="aspect-video overflow-hidden bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 relative">
                              <div className="absolute inset-0 flex items-center justify-center">
                                <Button size="icon" variant="secondary" className="h-14 w-14 rounded-sm">
                        ...
                        {tutorials.slice(3, 5).map((tutorial) => (
                          ...
                          >
                            <div className="flex-shrink-0">
                              <div className="relative h-20 w-20 overflow-hidden rounded-none bg-gradient-to-br from-teal-500 to-emerald-600">
                                <div className="absolute inset-0 flex items-center justify-center">
